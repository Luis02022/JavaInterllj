package com.senai.aulinha.except;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EmailCadastradoExceptio.class)
    public ResponseEntity<Map<String, Object>> handlerEmailJaCadastrado(EmailCadastradoExceptio erro){
